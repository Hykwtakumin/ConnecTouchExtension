...
window.onload = () => __awaiter(this, void 0, void 0, function* () {
    ...
    const localURL = yield util_1.getStorage("endpointURL");
    const localCardNumber = yield util_1.getStorage("targetCardNumber");
    if (localURL[0]) {
    ...
    const storeSettingsToLocal = () => __awaiter(this, void 0, void 0, function* () {
        yield util_1.setStorage("endpointURL", endpointURL.value);
        yield util_1.setStorage("targetCardNumber", targetCardNumber.value);
